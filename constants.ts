...
export const MOCK_SUBTITLES: Subtitle[] = [
  { id: '1', start: 0, end: 4.5, text_en: "Welcome to the English Learning Player, a new way to learn English.", text_cn: "欢迎来到 English Learning Player，这是一种学习英语的新方法。" },
  ...
  { id: '5', start: 18.0, end: 22.5, text_en: "You can import your own subtitles and connect your own AI API key.", text_cn: "您可以导入自己的字幕并连接自己的 AI API 密钥。" },
